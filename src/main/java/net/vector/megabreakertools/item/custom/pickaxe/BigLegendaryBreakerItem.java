package net.vector.megabreakertools.item.custom.pickaxe;
...
public class BigLegendaryBreakerItem extends DiggerItem {
    public BigLegendaryBreakerItem(Tier pTier, Properties pProperties) {
