...
public class ModMegaToolTiers {
    public static final Tier IGNITHRA = new ForgeTier(800, 4f, 0f, 15,
            ModTags.Blocks.NEEDS_IGNITHRA_TOOL, () -> Ingredient.of(ModItems.IGNITHRA.get()),
            ModTags.Blocks.INCORRECT_FOR_IGNITHRA_TOOL);
    public static final Tier ASTRALITE = new ForgeTier(1300, 6f, 0f, 20,
            ModTags.Blocks.NEEDS_ASTRALITE_TOOL, () -> Ingredient.of(ModItems.ASTRALITE.get()),
            ModTags.Blocks.INCORRECT_FOR_NEEDS_ASTRALITE_TOOL);
    public static final Tier NEXALITE = new ForgeTier(1300, 7f, 0f, 20,
            ModTags.Blocks.NEEDS_NEXALITE_TOOL, () -> Ingredient.of(ModItems.NEXALITE.get()),
            ModTags.Blocks.INCORRECT_FOR_NEEDS_NEXALITE_TOOL);
    public static final Tier ZENITHRA = new ForgeTier(2300, 8f, 0f, 25,
            ModTags.Blocks.NEEDS_ZENITHRA_TOOL, () -> Ingredient.of(ModItems.ZENITHRA.get()),
            ModTags.Blocks.INCORRECT_FOR_NEEDS_ZENITHRA_TOOL);
    public static final Tier CELESTINE = new ForgeTier(2300, 9f, 0f, 25,
            ModTags.Blocks.NEEDS_CELESTINE_TOOL, () -> Ingredient.of(ModItems.CELESTINE.get()),
            ModTags.Blocks.INCORRECT_FOR_CELESTINE_TOOL);
    public static final Tier OBSCURITE = new ForgeTier(4600, 10f, 0f, 30,
